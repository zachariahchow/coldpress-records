...
const CheckoutPage = ({ customerFieldChangeHandler, customerFields, cartData, confirmOrderHandler }) => {
        ...
        return (
                ...
                {cartData.length ? <div className="checkout-form__container w-full flex flex-col justify-center items-center">
                ...
                {cartData.length ? <div className="checkout-form-confirm__btn-container">
                ...
                {cartData.length ? <CheckoutTally key={Math.random * 99} cartData={cartData}/> : <div className="no-items__header w-full flex flex-col justify-center items-center">
