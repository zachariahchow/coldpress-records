...
const TopNav = () => {
    ...
    //CSS classes
    const linkClasses = ['h-4 w:auto py-2 px-2 text-center uppercase tracking-widest hover:underline'];

    return (
        <nav className={`h:auto px-8 py-2 w-1/3 absolute top-0 flex justify-between items-center fixed z-10 top-0 left-0 invisible md:visible text-white text-xl`}>
