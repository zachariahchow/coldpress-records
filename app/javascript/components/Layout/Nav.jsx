...
const Nav = ({ isMenuOpen }) => {
    ...
    return (
        <nav className={`h-screen flex flex-col justify-center items-center fixed z-10 top-0 left-0 w-full sm:w-1/2 bg-gray-200 opacity-25 ${isMenuOpen ? "transform -translate-x-0" : "transform -translate-x-full"}`}>
