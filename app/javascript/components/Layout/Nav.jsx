...
const Nav = ({ isMenuOpen, setIsMenuOpen }) => {
    ...
    return (
        <nav className={`h-screen flex flex-col justify-center items-center fixed z-10 top-0 left-0 w-full md:w-1/2 bg-gray-200 opacity-75 ${isMenuOpen ? "transform -translate-x-0 ease-in-out duration-700" : "transform -translate-x-full ease-in-out duration-700"}`}>
